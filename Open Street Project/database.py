...
con = sqlite3.connect("Centraldelhi.db")
con.text_factory = str
cur = con.cursor()

# create nodes table
cur.execute("CREATE TABLE nodes (id, lat, lon, user, uid, version, changeset, timestamp);")
with open('D:/Udacity/Open Street Project/nodes.csv','rb') as fin:
...
with open('D:/Udacity/Open Street Project/nodes_tags.csv','rb') as fin:
    dr = csv.DictReader(fin) 
...
with open('D:/Udacity/Open Street Project/ways.csv','rb') as fin:
    dr = csv.DictReader(fin) 
...
with open('D:/Udacity/Open Street Project/ways_nodes.csv','rb') as fin:
    dr = csv.DictReader(fin) 
...
with open('D:/Udacity/Open Street Project/ways_tags.csv','rb') as fin:
    dr = csv.DictReader(fin) 
    to_db = [(i['id'], i['key'], i['value'], i['type']) for i in dr]
